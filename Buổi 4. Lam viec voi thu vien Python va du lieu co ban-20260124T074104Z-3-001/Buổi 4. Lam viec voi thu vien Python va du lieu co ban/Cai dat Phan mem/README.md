# Danh sách phần mềm cần cài đặt cho buổi học thứ tư
...
```sh
pip install numpy pandas matplotlib yfinance metatrader5 scikit-learn sqlalchemy pyodbc xlsxwriter
```

## 4. MetaTrader 5 (Tùy chọn)
...
4. (Tùy chọn) Cài đặt MetaTrader 5 nếu muốn học về phần mềm giao dịch 